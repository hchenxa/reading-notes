...
## 工作流程
![broker]({{ site.baseurl }}/kafka/images/broker/broker.png)
...
### Follower故障处理
![follower故障处理]({{ site.baseurl }}/kafka/images/broker/follower故障处理细节.png)
处理流程：
...
### Leader故障处理
![leader故障处理]({{ site.baseurl }}/kafka/images/broker/leader故障处理.png)
处理过程：
...
log文件内容如下：
![logs]({{ site.baseurl }}/kafka/images/broker/logs.png)

log文件和index文件详解
![segment]({{ site.baseurl }}/kafka/images/broker/segment.png)
...
相同的key只保留最新的数据
![compact]({{ site.baseurl }}/kafka/images/broker/compact.png)
...
4. 页缓存和零拷贝技术
  ...
  ![零拷贝]({{ site.baseurl }}/kafka/images/broker/零拷贝.png)
